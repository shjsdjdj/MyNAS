...
Start-Process -FilePath $Python -ArgumentList '-m','uvicorn','backend.main:app','--host','127.0.0.1','--port','8000','--no-server-header' -WorkingDirectory $Root -WindowStyle Hidden
